...
public static double[] launch() {
    ...
    modelPath[0] = "models/Llama-3.2-1B-Instruct-Q4_K_M.gguf";
    modelPath[1] = "models/Qwen2.5-Coder-1.5B-Instruct-Q4_K_M.gguf";
    modelPath[2] = "models/Qwen2.5-0.5B-Instruct-Q4_K_M.gguf";
    double[] Token_persecond = new double[9];
    int tokenmapping=0;
    HttpClient client = HttpClient.newHttpClient();
    String osName = System.getProperty("os.name").toLowerCase();
    String baseName= "llamafile-0.10.4-thin";
    File execFile = Paths.get("resources", "llamafile", baseName).toFile();
